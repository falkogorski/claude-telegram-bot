...
Der Netcup-Server hat **keine Grafikeinheit**, acht Gigabyte Arbeitsspeicher und vier Kerne. Darauf läuft ein Modell mit knapp vier Milliarden Parametern — gut genug für Überschriften aus drei bis sieben Wörtern, nicht gut genug für eine Vertretung. Die Messung vom 25. Juli zeigt zudem, dass die Ollama-Spitze bereits 5,10 Gibibyte erreicht hat, also einen erheblichen Teil des vorhandenen Speichers.
