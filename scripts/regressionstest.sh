...
# 24.09.: Kurs-Videos — Eingang und Stand. Ohne Riegel laese ein Pruefer den
...
run "Nebenfaden: vier Wege waehrend eines Vorgangs (26.09.)" "$PY" scripts/test_nebenfaden.py
