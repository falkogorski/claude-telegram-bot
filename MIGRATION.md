...
- **➡️ AKTUELLER ARBEITSSTRANG (Stand 23.07.2026, Adams Pause):** Härtetest ✅, 5.9 ✅ VERIFIZIERT, 5.25 deployt. **8.6 (b) + 8.7 sind GEBAUT** (Selbstcheck lokal 18/18) und warten als Bündel auf den nächsten Deploy. 🔴 **NACH ADAMS PAUSE — AKTIV ERINNERN:** (1) Deploy des 8.6b/8.7-Bündels (die Startnachricht ist zugleich die Erinnerung), (2) die **sechs 5.25-Tests** (Recherche ohne Klicks · 💰-Dialog · .env-Schutz · Always-Allow nach Neustart · Mehrquellen-Liste · Herkunfts-Schranke bei Seiten-Verweisen). Danach **Phasen-Audit 5 → Phase 3** (LobeChat). Trainer-PDF: Kontroll-Prüfung BESTANDEN, zweites Referenz-Artefakt in `docs/referenzen/`. Mitlaufend: Blaupause-Sammelpflicht je Punkt.
...
- **Status:** 🔄 **DEPLOYT (23.07. früh, Selbstcheck 16/16 auf dem VPS)** — Adam-Tests (1)–(6) stehen aus
...
- **Status:** 🔄 **LÄUFT — Vorlage liegt vor (23.07., vorgezogen auf Adam-Wunsch):** [`docs/entscheidungsvorlagen/6-6-kanal-struktur-vorlage.md`](docs/entscheidungsvorlagen/6-6-kanal-struktur-vorlage.md) — sechs Vorschläge als 👍/👎-Häkchen-Liste, abgeleitet aus der **Häufigkeits-Analyse der echten Tageslogs** (Technik 270 · Recherchen 102 · Fußball 99 · Business 66 · Rechnungen/Termine je 12 · Rot ~0), mit Auto-/Manuell-Routing je Kanal und 4.3-Ordner-Spiegelung („Struktur über Namen"). **Noch nichts angelegt** — Bau nach Phase 3, gemeinsam.
