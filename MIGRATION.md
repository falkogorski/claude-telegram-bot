...
- **Status:** LÄUFT — **5.22a Threads ✅ live** (`efba6d9`: alle 4 Kerne, medium 47 s→25 s gemessen), **5.22b Umschalter ✅ live** (`3404f84`), Adam-Telegram-Test offen; Button-Ausdünnung nach Praxisphase.
