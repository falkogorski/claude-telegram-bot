...
- **Status:** VERIFIZIERT (Kern) — **5.22a Threads ✅** (`efba6d9`: alle 4 Kerne, medium 47 s→25 s), **5.22b Umschalter ✅** (`3404f84`). **Adam 15.07.: „Funktioniert sehr gut."** Offen nur noch die optionale Button-Ausdünnung (nach Praxisphase).
...
- **Status:** LÄUFT — implementiert + auf VPS E2E bewiesen (`d2b3037`), Adam-Telegram-Test offen.
