...
- **➡️ AKTUELLER ARBEITSSTRANG (Stand 24.07.2026):** **Phasen-Audit 5 passiert; Phase-6-Bau vorgezogen.** 6.6 FINAL v3 entschieden (4 Häuser/13 Zimmer), **6.5 gebaut + deploy-bereit** (Bot legt Zimmer bei Adams Forum-Gruppen selbst an), 6.1-Routing-Fundament gelegt. **Wartet auf Adam:** (a) die vier Gruppen anlegen (dann richtet der Bot die Zimmer selbst ein — E2E-Verifikation von 6.5/6.1); (b) **1.9-Webhook-Umschaltmoment** (Self-Signed auf IP, rote Auflagen aktiv — gemeinsam, ~10 Min). **Nächste Nacht laut Sprint:** 8.1 (mit AGB-Faktensammlung davor) + 8.3; LobeChat 3.1 (nur via Tunnel).
